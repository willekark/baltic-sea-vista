...
CREATE TABLE public.port_calls (
  ...
  call_type text NOT NULL DEFAULT 'commercial',
  scheduled_arrival timestamp with time zone,
  actual_arrival timestamp with time zone,
  scheduled_departure timestamp with time zone,
  actual_departure timestamp with time zone,
  berth_number text,
  cargo_operations jsonb DEFAULT '{}',
...
CREATE INDEX idx_port_calls_vessel_port ON public.port_calls(vessel_id, port_id);
CREATE INDEX idx_port_calls_status ON public.port_calls(status);
CREATE INDEX idx_port_calls_arrival ON public.port_calls(scheduled_arrival);
...
CREATE TRIGGER update_port_calls_updated_at
