  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-gradient-surface backdrop-blur-sm border border-white/5 text-secondary-foreground hover:bg-secondary/60 shadow-panel hover:shadow-tech hover:-translate-y-0.5",
        ...
        hero: "border border-white/20 bg-gradient-premium text-black hover:bg-gradient-investment hover:text-white shadow-investment hover:shadow-glow font-semibold hover:-translate-y-1 hover:scale-105",
      },
      size: {
